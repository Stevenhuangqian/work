...
import com.core.work.constants.ReturnConstans;
...
public class EntityValidator {
            ...
            for (Field f : fields) {
                ...
                for (Annotation annotation : arrayAno) {
                    ...
                    for (Method method : methodArray) {
                        ...
                        Object obj = EntityValidator.class.newInstance();
                        // 获取方法
                        try {
                            // 根据方法名获取该方法
    ...
    public Map<String, Object> isEmpty(Object value, Field field) {
        ...
        EmptyReg annotation = field.getAnnotation(EmptyReg.class);
        if(value == null || value.equals("")) {
            validateResult.put("message", field.getName() + annotation.message());
            validateResult.put("result", false);
        } else {
            validateResult.put("message", ReturnConstans.SUCCESS_MSG);
...
//        rc.setLang("1");
        rc.setSessionToken("1");
        System.out.println(EntityValidator.validate( rc));
    }
